...
\section{Revisão Sistemática}
	...
	\subsection{Método de Pesquisa}
		...
		\subsubsection{Bases de dados relevantes}
			...
			\nomenclature{SBQS}{Simpósio Brasileiro de Qualidade de Software}%
			\nomenclature{ICSE}{International Conference on Software Engineering}%
			\nomenclature{WBMA}{Workshop Brasileiro de Métodos Ágeis}%
			\nomenclature{XP}{eXtreme Programming}%
