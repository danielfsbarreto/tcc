...
\begin{figure}[h]
	...
	\makebox[\textwidth]{\includegraphics[width=\textwidth]{capitulos/las/figuras/exp.eps}}
...
\begin{figure}[h]
	\centering
	\captionsetup{justification=centering}
	\makebox[\textwidth]{\includegraphics[width=\textwidth]{capitulos/las/figuras/backlog.eps}}
	\caption{Gráfico com o percentual de trabalhos que referenciam lições aprendidas da categoria ``Planejamento e gerenciamento de backlog"}
	\label{fig:backlog}
\end{figure}
