...
\begin{table}[H]
	...
	\end{tabularx}
	\caption{Lições aprendidas agrupadas na categoria ``Apoio gerencial e dos clientes"}
\end{table}
...
\begin{figure}[H]
	...
	\caption{Percentual de trabalhos que referenciam lições aprendidas da categoria ``Comunicação remota"}
...
\begin{figure}[H]
	...
	\caption{Percentual de trabalhos que referenciam lições aprendidas da categoria ``Cultura organizacional"}
	\label{fig:cultura}
\end{figure}
